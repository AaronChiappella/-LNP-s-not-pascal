...
const
  max= 9;
  Type
    t_simbolo_gramatical= (error, tid, tdec, tpuntoycoma, treal, tlista, tparentesisa, tparentesisc, tcoma, tpunto, tmas,tconst, tigual, tmayor, tmenor, tmenos, tpor, tbarra, traiz, tpotencia,
    ...
    vprograma1, vsentencia, vsentencia1, vlist_var, vcond, vcond1, vcondP, vboolTerm, vboolTerm1, vboolTermP, vboolFactor, vexprel, voprel,
